        ...
        <header className={`py-4 ${!transparentHeader ? 'border-b border-muted' : ''}`}>
          <div className="container flex justify-between items-center">
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold chrome-text group-hover:scale-105 transition-transform">
                  Trivia Time Machine
                </h1>
      ...
      {showFooter && (
        <footer className="py-4 border-t border-muted">
          <div className="container text-center text-sm text-muted-foreground">
            <p>© 2023 Trivia Time Machine - Created for Tom's 50th Birthday</p>
          </div>
        </footer>
      )}
    </div>
