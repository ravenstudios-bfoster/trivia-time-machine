...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center p-6 overflow-hidden bg-gradient-to-b from-gray-900 via-blue-900 to-black">
      ...
      <div className="w-full max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <h2 className="text-2xl md:text-3xl text-blue-300 mt-4" style={{ fontFamily: "'Orbitron', sans-serif" }}>
              Tom's 50th: The Birthday Paradox
            </h2>
          </div>
        </div>
        ...
        <div className="bg-black/60 backdrop-blur-md border-2 border-blue-600/30 rounded-lg p-8 mb-10 mx-auto max-w-md shadow-[0_0_25px_rgba(0,100,255,0.6)]">
          ...
          <div className="flex flex-col space-y-4">
            <GameButton onClick={handleStartGame} fullWidth>
              Start Time Travel
            </GameButton>
        ...
        <div className="text-gray-400 text-xs mt-8">"Roads? Where we're going, we don't need roads."</div>
      </div>
    </div>
  );
};
